...
class TestManagementService
{
    ...
    public function testsFor(int $userId, int $schoolId): Collection
    {
        ...
        $levelToRoot = $this->levelToRootMap($schoolId, $roots);
    ...
    public function assignedRoots(int $userId, int $schoolId, Collection $tests): Collection
    {
        ...
        $present = $this->sectionRootsFor($userId, $schoolId, $roots)
     ...
     */
    private function sectionRootsFor(int $userId, int $schoolId, Collection $roots): Collection
    {
        $nodeRoot = EducationLevels::nodeRootMap();
        $basicRootId = $this->basicRootId($roots);
     ...
     */
    private function levelToRootMap(int $schoolId, Collection $roots): array
    {
    ...
    private function basicRootId(Collection $roots): int
    {

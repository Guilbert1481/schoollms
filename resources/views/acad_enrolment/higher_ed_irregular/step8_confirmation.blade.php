...
<div style="text-align:center;padding:40px 20px;">
    ...
    <div style="max-width:580px;margin:0 auto;background:#fff;border:1px solid #e2e8f0;border-radius:12px;padding:20px;text-align:left;font-size:14px;">
        ...
        <div style="margin-bottom:8px;"><strong>Education Level:</strong> {{ ucfirst($enrollment->education_level) }}</div>
        <div style="margin-bottom:8px;"><strong>Total Units:</strong> {{ $enrollment->total_units }} units · {{ $enrollment->subjects()->count() }} classes</div>
    ...
    <p style="margin-top:32px;color:#64748b;font-size:13px;">
        Irregular enrolments require approval from your program head or the dean.
        You will receive an email once your enrolment is reviewed.
    </p>

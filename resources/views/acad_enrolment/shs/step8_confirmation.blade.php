...
<div style="text-align:center;padding:40px 20px;">
    ...
    <div style="max-width:560px;margin:0 auto;background:#fff;border:1px solid #e2e8f0;border-radius:12px;padding:20px;text-align:left;font-size:14px;">
        ...
        <div style="margin-bottom:8px;"><strong>Education Level:</strong> Senior High School</div>
    ...
    <p style="margin-top:32px;color:#64748b;font-size:13px;">
        You will receive an email once your enrolment is reviewed by the SHS subject coordinator. You may close this page.
    </p>

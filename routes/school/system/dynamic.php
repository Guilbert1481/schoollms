...
Route::prefix('school/system/dynamic')
    ->middleware(['web', 'auth', 'role:admin,superadmin,academics,admission_manager,registrar,finance_manager,dean,principal,program_head,course_architect,subject_coordinator,teacher,guidance_counselor,trainor,training_program_head'])
    ->group(function () {

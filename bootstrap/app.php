...
return Application::configure(basePath: dirname(__DIR__))
    ...
    ->withRouting(
        ...
        web: [
            ...
            */
            ...
            __DIR__.'/../routes/student/records.php',
    ...
    ->withMiddleware(function (Middleware $middleware) {
        ...
        $middleware->web(append: [
            ...
            // Shorter idle timeout for privileged roles (D4): logs staff out
            // after a period of inactivity, protecting shared office machines.
